package com.mygdx.finalgangwar.mariobros.Sprites.Enemies;
...
public class Turtle extends Enemy {
    ...
    public Turtle(PlayScreen screen, float x, float y) {
        ...
        frames.add(new TextureRegion(screen.getAtlas().findRegion("punk_walk"), 0, 0, 16, 24));
        frames.add(new TextureRegion(screen.getAtlas().findRegion("punk_walk"), 16, 0, 16, 24));
        shell = new TextureRegion(screen.getAtlas().findRegion("punk_walk"), 64, 0, 16, 24);
